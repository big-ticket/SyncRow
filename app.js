...
`		@keyframes myAnim {
	...
	if (isSafari){
		// I read online that you need to force safari to re-render an element to get the animation to update
		// Quickly swap the rower to hidden and back
		elem_rower.style.display = "none";
		setTimeout(() => {elem_rower.style.display = "";}, 0)
	}
